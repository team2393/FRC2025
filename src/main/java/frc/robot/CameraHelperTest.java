...
public class CameraHelperTest
{
  ...
  public CameraHelperTest (AprilTagFieldLayout tags, String camera_name, double pos_x, double pos_y, double pos_z)
  {
    ...
    robotToCam = new Transform3d(new Translation3d(pos_x, pos_y, pos_z), new Rotation3d(0,0,0));
